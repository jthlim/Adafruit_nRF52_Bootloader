...
#define CFG_UF2_NUM_BLOCKS 0x42000
...
#if defined(USB_DESC_VID) && defined(USB_DESC_UF2_PID) && USB_DESC_VID &&      \
    USB_DESC_UF2_PID
...
// Address where new bootloader is written before activation (skip application
// data)
